    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-4 pb-16 space-y-12">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Testimonial text="Smooth booking and a spotless car. Weekend trip was perfect!" author="Asha, Chennai" />
            <Testimonial text="Listing my car took 10 minutes. Now it’s earning when I'm not using it." author="Rahul, Provider" />
            <Testimonial text="Prices were clear and the owner responded quickly. Would recommend." author="Meera, Bengaluru" />
          </div>
        </section>
